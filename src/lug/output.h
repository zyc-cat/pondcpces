...
//void print_CodeNode( CodeNode *node, int indent ); // compiling
void print_vector( BitVector *vec, int vec_len ); // compiling
...
void print_fact_info( FactInfo *f_info, int vec_len ); // compiling

void spec_error( char *s );
//void print_plop( PlOperator *plop );
//void print_CodeOperator( CodeOperator *op );

void print_BitOperator( BitOperator *o ); // compiling
